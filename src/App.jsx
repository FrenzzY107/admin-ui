...
function App() {
  return (
    <main className="bg-special-maiBg flex min-h-screen justify-center items-center">
      {/* container start */}
      <div className="w-full max-w-sm">
        ...
        {/* logo end */}
          ...
          <form action="">
            <div className="mb-6">
              ...
              <input
                type="email"
                className="text-sm rounded-md w-full bg-special-mainBg border border-gray-03 text-gray-01 focus:border-black focus:outline-none focus:ring-0"
        ...
        {/* form end */}
          ...
          <div class="bg-special-mainBg absolute"> or sign in with</div>
        </div>
        {/* teks end */}
